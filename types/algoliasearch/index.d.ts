...
declare namespace algoliasearch {
    ...
    interface Client {
         ...
         */
        search<T extends AlgoliaObject>(
            queries: {
                indexName: string;
                query: string;
    ...
    interface Index {
        ...
        getObject(
            objectID: string,
            cb: (err: Error, res: AlgoliaRecord) => void
        ): void;
        /**
        ...
        getObjects(
            objectIDs: string[],
            cb: (err: Error, res: { results: AlgoliaRecord[] }) => void
        ): void;
        /**
         ...
         * https://github.com/algolia/algoliasearch-client-js#find-by-ids---getobjects
         */
        getObjects(objectIDs: string[]): Promise<{ results: AlgoliaRecord[] }>;
        /**
         * Add a list of objects
         * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
         */
        addObject(object: AlgoliaObject, objectID?: string): Promise<Task>;
        /**
         * Add list of objects
         * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
         */
        addObjects(objects: AlgoliaObject[]): Promise<Task>;
        /**
         * Add or replace a specific object
         * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
         */
        saveObject(object: AlgoliaRecord): Promise<Task>;
        /**
         * Add or replace several objects
         * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
         */
        saveObjects(objects: AlgoliaRecord[]): Promise<Task>;
        /**
         * Update parameters of a specific object
         * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
         */
        partialUpdateObject(object: AlgoliaObject): Promise<Task>;
        /**
         * Update parameters of a list of objects
         * https://github.com/algolia/algoliasearch-client-js#update-objects---saveobjects
         */
        partialUpdateObjects(objects: AlgoliaObject[]): Promise<Task>;
        /**
         * Delete a specific object
         * https://github.com/algolia/algoliasearch-client-js#delete-objects---deleteobjects
         */
         ...
         */
        search<T>(params: QueryParameters): Promise<Response<T>>;
        /**
         * Search in an index
         * https://github.com/algolia/algoliasearch-client-js#search-in-an-index---search
         */
         ...
         * https://github.com/algolia/algoliasearch-client-js#backup--export-an-index---browse
         */
        browseAll<T>(): Promise<Response<T>>;
        /**
         * Clear an index content
         * https://github.com/algolia/algoliasearch-client-js#clear-index---clearindex
         */
    ...
    type AlgoliaValue = string | number | AlgoliaValueArray | AlgoliaObject;
    interface AlgoliaValueArray extends Array<AlgoliaValue> {}
    type AlgoliaObject<
        Shape extends { [key in Attribute]: AlgoliaValue } = {}
    > = Shape;
    type AlgoliaRecord<Shape extends AlgoliaObject = {}> = {
        objectID: ObjectID;
    } & Shape;
}
